...
func NewNOWPayments(provider nowpayments.Provider, payments *payment.Service, log *slog.Logger) *NOWPayments {
	return &NOWPayments{provider: provider, payments: payments, log: log}
}
